    ...
    public CommandExecutorFire(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        switch  (si.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("CommandExecutorFire.PathPlanning", "adf.component.module.algorithm.PathPlanning");
                this.actionFireFighting = moduleManager.getExtAction("CommandExecutorFire.ActionFireFighting", "adf.component.extaction.ExtAction");
                this.actionExtMove = moduleManager.getExtAction("CommandExecutorFire.ActionExtMove", "adf.component.extaction.ExtAction");
                break;
            case PRECOMPUTED:
                this.pathPlanning = moduleManager.getModule("CommandExecutorFire.PathPlanning", "adf.component.module.algorithm.PathPlanning");
                this.actionFireFighting = moduleManager.getExtAction("CommandExecutorFire.ActionFireFighting", "adf.component.extaction.ExtAction");
