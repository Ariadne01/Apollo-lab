...
public class ApolloSampleFireSearch extends Search { // sample
    ...
    public ApolloSampleFireSearch(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        this.sendingAvoidTimeReceived = developData.getInteger("ApolloSampleFireSearch.sendingAvoidTimeReceived", 3);
        this.sendingAvoidTimeSent = developData.getInteger("ApolloSampleFireSearch.sendingAvoidTimeSent", 5);

        StandardEntityURN agentURN = ai.me().getStandardURN();
        switch  (si.getMode()) {
            case PRECOMPUTATION_PHASE:
                if(agentURN == AMBULANCE_TEAM) {
                    this.pathPlanning = moduleManager.getModule("Search.PathPlanning.Ambulance", "adf.component.module.algorithm.PathPlanning");
                    this.clustering = moduleManager.getModule("Search.Clustering.Ambulance", "adf.component.module.algorithm.StaticClustering");
                } else if(agentURN == FIRE_BRIGADE) {
                    this.pathPlanning = moduleManager.getModule("Search.PathPlanning.Fire", "adf.component.module.algorithm.PathPlanning");
                    this.clustering = moduleManager.getModule("Search.Clustering.Fire", "adf.component.module.algorithm.StaticClustering");
                } else if(agentURN == POLICE_FORCE) {
                    this.pathPlanning = moduleManager.getModule("Search.PathPlanning.Police", "adf.component.module.algorithm.PathPlanning");
                    this.clustering = moduleManager.getModule("Search.Clustering.Police", "adf.component.module.algorithm.StaticClustering");
                }
                break;
            case PRECOMPUTED:
                if(agentURN == AMBULANCE_TEAM) {
