...
public abstract class AbstractSearchStrategy {
    ...
    private static Log logger = LogFactory.getLog(AbstractSearchStrategy.class);
    ...
    AbstractSearchStrategy(ApolloWorld world, WorldInfo worldInfo, AgentInfo agentInfo) {
        this.world = world;
