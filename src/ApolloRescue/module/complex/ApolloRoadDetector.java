...
import ApolloRescue.module.algorithm.clustering.ConvexHull;
...
public class ApolloRoadDetector extends RoadDetector {
    ...
    public ApolloRoadDetector(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        public RoadDetector calc() {
            ...
            if (this.result == null) {
                java.util.List<EntityID> removeList = new ArrayList<>(this.priorityRoads.size());
                ...
                java.util.List<EntityID> path = this.pathPlanning.calc().getResult();
...
//                java.util.List<Integer> elementList = Util.fetchIdValueFormElements(civilians);
...
//                }
    ...
    private void addBlockedAgentsToTargets() {
        java.util.List<StandardEntity> agents = new ArrayList<>(
...
//                                this.targetAreas.add(blockageRoadPosition.getID());
    ...
    private boolean amIResponsibleFor(StandardEntity agent) {
        ...
        java.util.List<StandardEntity> visiblePoliceForces = new ArrayList<>();
    ...
    private void addBlockedRefugesToTargets() {
        java.util.List<StandardEntity> refuges = new ArrayList<>(
                worldInfo.getEntitiesOfType(
...
//                                    System.out.println("SAW----Roads to Clear for civilian: " + agentInfo.getTime() + " agentId: " + agentInfo.getID() + " civId: " + civilian.getID() + " roadId: " + neighbour.getID());
                            ...
                            java.util.List<Entrance> entrances = world.getBuildingModel(target.getID()).getEntrances();
