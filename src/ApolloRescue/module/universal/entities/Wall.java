...
public class Wall {
    ...
    public Wall(int x1, int y1, int x2, int y2, BuildingModel owner, float rayRate) {
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
        this.y2 = y2;
    ...
    public void findHits(ApolloWorld world, BuildingModel buildingModel) {
//        BuildingHelper buildingHelper=world.getHelper(BuildingHelper.class);
        ...
        for (int emitted = 0; emitted < rays; emitted++) {
            ...
            if (start == null) {
                strange++;
//                System.out.println("strange -> " + a.x + "," + a.y + "/" + b.x + "," + b.y); XXX
                continue;
            }
            ...
            ArrayList<Wall> listWall = buildingModel.getAllWalls();
...
//                Hashtable hashtable=buildingHelper.getBuildingConnectedTable(this.owner.getID());
                Hashtable hashtable = buildingModel.getConnectedBuildingsTable();
