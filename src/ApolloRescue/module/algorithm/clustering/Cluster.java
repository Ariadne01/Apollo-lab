...
import ApolloRescue.module.algorithm.convexhull.ConvexObject;
...
public abstract class Cluster {
    ...
    public void eat(ApolloRescue.module.algorithm.clustering.Cluster cluster) {
     ...
     *
     * @param  : Is the Polygon that we want to scale
     * @param         : Is the scale coefficient, It actually multiplies to the points and makes the new shape
...
//
//        if(p1 == null || pc == null) {
//        	System.err.println("p1 or pc is null");  // XXX print
//        }
//
