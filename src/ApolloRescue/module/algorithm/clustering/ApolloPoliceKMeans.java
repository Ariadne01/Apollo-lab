 ...
 */
public class ApolloPoliceKMeans extends StaticClustering {
    ...
    public ApolloPoliceKMeans(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
...
//        this.assignAgentsFlag = developData.getBoolean("sample.module.SampleKMeans.assignAgentsFlag", true);
        List<EntityID> centerIDs = new ArrayList<>();
        Map<Integer, List<StandardEntity>> clusterEntitiesList = new HashMap<>();
        this.clusterEntitiesMap = new HashMap<>();
        this.clusterEntityIdsMap = new HashMap<>();
        List<StandardEntity> centerList = new ArrayList<>();
