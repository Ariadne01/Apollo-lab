...
public interface ApolloConstants {
    ...
    /** <b>Note: </b>relate to fb precompute*/
    ...
    public static final Color VIEWER_BACKGROUND_COLOR = new Color(255, 255, 190);

    //AGENT
    public static final int IN_TARGET = 0;
    public static final boolean DO_NOT_MOVE_IN_BURNING_BUILDING = true;
    public static final double MEAN_VELOCITY_OF_MOVING = 31445.392; //平均移动速率
    ...
    public static final String CLEAR_RATE_KEY = "clear.repair.rate";
    //AMBULANCE TEAM
    ...
    public static final double AGENT_RADIUS = 500; // Can be read from Configure
