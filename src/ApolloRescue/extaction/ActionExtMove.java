...
import ApolloRescue.extaction.move.RayMoveActExecutor;
    ...
    public ActionExtMove(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DevelopData developData) {
        ...
        switch  (scenarioInfo.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("ActionExtMove.PathPlanning", "adf.component.module.algorithm.PathPlanning");
                break;
            case PRECOMPUTED:
                this.pathPlanning = moduleManager.getModule("ActionExtMove.PathPlanning", "adf.component.module.algorithm.PathPlanning");
                break;
        ...
        rayMoveActExecutor = new RayMoveActExecutor(world, worldInfo, scenarioInfo, agentInfo);
    }
...
//        }
        ...
        if (!(pathPlanning instanceof ApolloPathPlanning)) {
...
//        setThisCycleMoveToPoint(true); //ljy TODO:Check
    ...
    private boolean stuckCondition(List<EntityID> plan) {
        ...
        int moveDistance = Util.distance(lastPositionCoordinate, positionCoordinate);
        lastPositionCoordinate = positionCoordinate;
        int STUCK_THRESHOLD = 2000;
